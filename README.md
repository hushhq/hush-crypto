...
The compiled WASM package is published to [npmjs.com](https://www.npmjs.com/package/@gethush/hush-crypto) as `@gethush/hush-crypto`. No extra authentication is needed to install it.
